...
<body>
    <div class="container">
        <form method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="Username" placeholder="<?php echo $name; ?>" disabled>
            </div>
            <div class="form-group">
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($update['Updated'] == 1) {
            $updatequery = "UPDATE patient SET PatientID='$patientID',Patientname = '$fullname', Allergies = '$allergies', Gender = '$gender', Age = $age WHERE username='$name';";
